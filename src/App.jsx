...
import blueShrimp from './assets/blueShrimp.jpg'
  ...
  return (
      <div className="min-h-screen bg-white text-slate-950">
        ...
        <main>
          ...
          <section className="relative bg-gradient-to-r from-sky-800 via-cyan-600 to-blue-700 bg-[length:200%_200%] animate-gradient-x px-4 py-5">

            {/* readability overlay */}
            <div className="absolute inset-0 bg-black/30" />

            <div className="relative mx-auto grid max-w-7xl gap-5 text-sm font-bold md:grid-cols-4 md:text-base text-white">
              {[
          ...
          <section id="baby-shrimp" className="bg-gradient-to-br from-sky-100 via-white to-blue-100 px-4 py-16 md:py-20">
            <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[0.95fr_1.05fr]">
              <div>
                <p className="text-sm font-black uppercase tracking-[0.25em] text-sky-700">
                  The Small Fry Nursery
                </p>
                <h2 className="mt-3 text-4xl font-black md:text-5xl">
                  Meet the tiniest residents of Small Fry Aquatics.
                </h2>
                <p className="mt-5 text-lg leading-8 text-slate-700">
                  This section shows off the baby shrimp growing up in my planted
                  tanks. They are not listed for sale; they are part of the
                  behind-the-scenes nursery.
                </p>
              </div>

              <div className="overflow-hidden rounded-[2rem] bg-[#071824] p-3 shadow-2xl">
                <div className="relative min-h-[390px] overflow-hidden rounded-[1.5rem]">
                  ...
                  <div className="absolute bottom-6 left-6 right-6 rounded-2xl border border-white/15 bg-white/10 p-6 text-white backdrop-blur-md">
                    ...
                    <p className="mt-3 text-sm leading-6 text-sky-50/85">
                      Add photos of your baby shrimp here.
                    </p>
                  </div>
                </div>
              </div>
